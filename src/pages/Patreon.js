  ...
  return (
    <Page>
      ...
      <p className="text-lg mb-8">
        Join our thriving community of AI enthusiasts and get exclusive perks by
        becoming a Patron. Your support fuels our mission to build cutting-edge
        on-demand apps with AI.
      </p>
